"""
Utility functions for Bloomberg Liquidity Risk Intelligence Platform
...
def clear_screen():
    ...
    each phase of the analysis. It's Bloomberg-standard practice to keep
...
def color_text(text, color):
    """Add color to terminal output for Bloomberg-style alerts
    
    Implements Bloomberg Terminal's signature color scheme:
    ...
    - \033[93m = bright yellow (Bloomberg orange)
    ...
    """
    colors = {
        'red': '\033[91m',    # Bloomberg Alert Red
        'green': '\033[92m',  # Bloomberg Status Green
        'yellow': '\033[93m', # Bloomberg Warning Orange
        'blue': '\033[94m',   
        'purple': '\033[95m',
        'cyan': '\033[96m',
        'white': '\033[97m',
...
def print_banner():
    """Print Bloomberg-style banner with warning message
    
    Creates the distinctive Bloomberg Terminal look with:
    - Yellow header bar (Bloomberg signature color)
    - Clear system identification
    - Warning message about demo nature
    
    This mimics Bloomberg Terminal's startup screen which always
    ...
    print(color_text("BLOOMBERG LIQUIDITY RISK INTELLIGENCE PLATFORM", 'yellow'))
    print(color_text("="*60, 'yellow'))
